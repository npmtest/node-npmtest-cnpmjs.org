...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-cnpmjs.org/node_modules/cnpmjs.org/models/total.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-cnpmjs.org/node_modules/cnpmjs.org/models/total.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-cnpmjs.org/node_modules/cnpmjs.org/models/</a> &#187; total.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >  return sequelize.define('Total', {</span>
    name: {
...
<span class="cstat-no" title="statement not covered" >        that.find({</span>
          where: { name: 'total' }
        }).then(<span class="fstat-no" title="function not covered" >function (row) {</span>
<span class="cstat-no" title="statement not covered" >          if (!row) {</span>
<span class="cstat-no" title="statement not covered" >            that.build({name: 'total'}).save()</span>
